...
class Site(OpinionSite):
    ...
    def _get_download_urls(self):
        return [e for e in self.html.xpath('//tr[./td[1]/a//text()]/td[1]/a/@href')]
    ...
    def _get_docket_numbers(self):
        return [e for e in self.html.xpath('//tr[./td[1]/a//text()]/td[2]//text()')]
    ...
    def _get_nature_of_suit(self):
        return [e for e in self.html.xpath('//tr[./td[1]/a//text()]/td[4]//text()')]
