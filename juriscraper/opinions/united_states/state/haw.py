...
class Site(OpinionSite):
    def __init__(self, *args, **kwargs):
        ...
        self.url = 'http://www.courts.state.hi.us/opinions_and_orders/opinions?yr=%s' % year
    ...
    def _download_backwards(self, year):
        ...
        if pages:
            ...
            for page in range(2, last_page + 1):
                self.url = 'http://www.courts.state.hi.us/opinions_and_orders/opinions/page/%d?yr=%s' % (page, year)
                self.html = self._download()
