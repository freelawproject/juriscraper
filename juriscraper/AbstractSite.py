...
from juriscraper.lib.utils import clean_attribute
...
class AbstractSite:
    ...
    def sanity_check_dates(self, dates_and_names: list[tuple]) -> None:
    ...
    def sanity_check_case_names(self, case_names: list[str]):
    ...
    def _check_sanity(self):
        ...
        self.sanity_check_case_names(self.cases_names)
        date_filed_is_approximate = getattr(
            self, "date_filed_is_approximate", [False for i in self.case_names]
        )
        self.sanity_check_dates(
