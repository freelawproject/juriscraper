...
class Site(GenericSite):
    ...
    def _get_download_urls(self):
        path = '//table[@class = "opinionsdata"]/tr/td[3][../td/text() = "S.Ct"][not(contains(../td/text(), "Bar"))]/a[1]/@href'
        return list(self.html.xpath(path))

    def _get_case_names(self):
        # There is often a missing link in a case, thus we need an extra check here.
        path = '//table[@class = "opinionsdata"]/tr/td[4][../td/a][../td/text() = "S.Ct"][not(contains(../td/text(), "Bar"))]/p[1]/text()[1]'
        case_names = []
    ...
    def _get_case_dates(self):
        path = '//table[@class = "opinionsdata"]/tr/td[1][../td/a][../td/text() = "S.Ct"][not(contains(../td/text(), "Bar"))]/text()'
    ...
    def _get_docket_numbers(self):
        path = '//table[@class = "opinionsdata"]/tr/td[3][../td/a][../td/text() = "S.Ct"][not(contains(../td/text(), "Bar"))]/a[1]/text()'
        return list(self.html.xpath(path))

    def _get_lower_courts(self):
        path = '//table[@class = "opinionsdata"]/tr/td[5][../td/a][../td/text() = "S.Ct"][not(contains(../td/text(), "Bar"))]'
        lower_courts = []
