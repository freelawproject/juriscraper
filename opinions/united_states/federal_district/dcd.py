    ...
    def _get_nature_of_suit(self):
        ...
        for url in self.html.xpath('//table[2]//tr[position()>0]/td[3]/a/@href'):
            ...
            if nature_code == 'cv':
                ...
                nos.append("Criminal")
            # This is a tough call. It appears all the Magistrate Cases are
            # Criminal cases, and their docket_number field will reflect
            # this, but they do classify these separately under this 'mj'
            # code and the first page of these documents will refer to
            # them as 'Magistrate Case ####-####' so, we will too.
            elif nature_code == 'mj':
