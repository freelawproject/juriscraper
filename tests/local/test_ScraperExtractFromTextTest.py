    ...
    test_data = {
        ...
        "juriscraper.opinions.united_states.state.lactapp_4": [
            (
                ...
                {"OpinionCluster": {"judges": "Daniel L. Dysart; Rosemary Ledet; Tiffany Gautier Chase; Nakisha Ervin-Knott; Monique G. Morial"},"Opinion": {"author_str": "Judge Monique G. Morial","type": "020lead"}}
             ),
            (
