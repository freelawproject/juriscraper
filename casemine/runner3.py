...
from juriscraper.opinions.united_states.federal_appellate import ca10, ca11_u, ca9_govinfo
from juriscraper.opinions.united_states.federal_bankruptcy import bank_d_nj, bank_d_vi, bank_ed_penn, bank_md_tenn, bank_wd_penn
from juriscraper.opinions.united_states.federal_district import d_alaska, d_idaho, d_new_mexico

site = bank_md_tenn.Site()

site.execute_job("bank_md_tenn")
